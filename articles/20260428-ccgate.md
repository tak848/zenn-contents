...
一方で、全部を自動許可したいわけではありません。むしろ安全にしたい。許可/不許可の判断基準は意外と言語化できます。であれば、その判断を本来の作業をしているAgentとは別の第三者AIに任せればよいのでは、という発想です。

基本的にはAgentに自由に動いてほしい。ただし、環境を壊しそうな操作や、プロジェクトの流儀から外れた操作は止めたい。人間が疲れた状態で読むより、Haikuだとしても毎回ちゃんと読ませた方が、よっぽど目が滑らないと思っています。理由付きで返せば、元のAgentにも「なぜダメなのか」が伝わります。
