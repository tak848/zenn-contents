...
ccgateは、Claude Codeの`PermissionRequest` hookとして動く小さなGo製CLIです。
...
最後に、Auto ModeやClaude Code hooksの仕様はかなり速く変わっています。この記事のClaude Code関連の事実は、2026年4月27日時点で公式ドキュメントを確認した内容に基づいています。使う前には、[Permission modes](https://code.claude.com/docs/en/permission-modes)、[Configure auto mode](https://code.claude.com/docs/en/auto-mode-config)、[Hooks reference](https://code.claude.com/docs/en/hooks)を確認してください。
